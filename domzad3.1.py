...
Для одной из промежуточных ступеней паровой турбины построить графически треугольники скоростей для 10 сечений
равномерно распределенных по высоте при следующих исходных данных:
* P_0 = 16,7 МПа
* t_0 = 520 ˚C
* Р_2 = 14,5 МПа
* D_{cр} = 0.892 м
...
def calc_traingals(p_0, t_0, p_2, avg_diameter, degree_of_reaction, alpha_1_deg, delta_beta_deg, fi, psi,
    ...
    """
    Функция строит графически треугольники скоростей для 10 сечений
    равномерно распределенных по высоте и сохраняет результат в папку.
    """
