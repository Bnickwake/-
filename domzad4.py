...
По аналогии с решением задач из практики, построить график зависимости
ηoi=f(H0) в диапазоне H0 = (50 - 150) kJkg. ηол = 78%. u=160m/s.
Все остальные переменные и условия принять такие же как на практическом заняти.
...
def resh_zad(p, t,H_0,u,d_r,s_div_r,degree__of_reaction,z_bandage,delta_r_bandage,delta_a_bandage,z_rotor,
d_leak_rotor,delta_leak_rotor,e,sin_alpha_1,blade_width,blade_length,blade_efficiency,segments,F1,K_y,mu_r_rotor,mu_r,mu_a
,mu_nozzle,kinematic_viscosity
        ):

    '''
    Функция строит график зависимости
    ηoi=f(H0) в диапазоне H0 = (50 - 150) kJkg и сохраняет его в папку:графики Шалыгин.
    ...
    file_path = os.path.join(folder_path, 'dz4graf1.png')
...
if __name__ == "__main__":
    ...
    """
    grafik = resh_zad(p, t,H_0,u,d_r,s_div_r,degree__of_reaction,z_bandage,delta_r_bandage,delta_a_bandage,z_rotor,
    d_leak_rotor,delta_leak_rotor,e,sin_alpha_1,blade_width,blade_length,blade_efficiency,segments,F1,K_y,mu_r_rotor,mu_r,mu_a
    ,mu_nozzle,kinematic_viscosity)
